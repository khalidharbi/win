...
<div class="container main-container p-4" style="border: 5px solid #3498db; border-radius: 15px; background-color: #f8f9fa;">

<div class="position-relative overflow-hidden p-3 p-md-5 m-md-3 text-center bg-light">
    <div class="col-md-5 p-lg-5 mx-auto ">
      <img src="images/ccna.png" alt="">
      <h1 class="display-4 fw-normal">اربح مع خالد</h1>
      <p class="lead fw-normal">باقي على فتح التسجيل</p>
      <h3 id="countdown"></h3>
      <p class="lead fw-normal">للسحب على مقعد مجاني في دورة CCNA </p>
    </div>
  </div>
  ...
  <div class="container">
        ...
        <ul class="list-group list-group-flush">
            ...
            <li class="list-group-item">الرابح سيحصل على مقعد مجاني في دورة CCNA</li>
        </ul>
  </div>
...
<div class="d-grid gap-2 col-6 mx-auto my-5">
    <button type="button" id="winner" class="btn btn-primary btn-lg">
         الرابح
    </button>
</div>
